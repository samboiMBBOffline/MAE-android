...
Mobile.scrollToText(findTestData('TestData').getValue(3, 3), FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Transfer/transferFavListAccNameTxt', [('accName') : findTestData('TestData').getValue(3, 3)]), 
    0)

Mobile.delay(3)

if(Mobile.verifyElementExist(findTestObject('Object Repository/Transfer/TypeOfTransaction',[('type'): 'NRIC Number']),0,FailureHandling.OPTIONAL))
		{
		
			Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyNumberTxt', [('proxyNumber') : findTestData('TestData').getValue(
				4, 2)]), findTestData('TestData').getValue(4, 2))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountReceipientNameTxt', [('recName') : findTestData('TestData').getValue(
				2, 3)]), findTestData('TestData').getValue(2, 3))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyTypeTxt', [('proxyType') : findTestData('TestData').getValue(
				2, 2)]), findTestData('TestData').getValue(2, 2))
...
Mobile.setText(findTestObject('Banking/duitNowReferenceInputField'), reference, 0)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Duit Now/duitNowReferenceContentTxt', [('reference') : reference]), reference)
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationReceipientProxyNumTxt', [('proxyNumber') : findTestData(
				'TestData').getValue(4, 2)]), findTestData('TestData').getValue(4, 2))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationReferenceTxt', [('reference') : findTestData('TestData').getValue(
				8, 4)]), findTestData('TestData').getValue(8, 4))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationPaymentDetailsInputtedTxt', [('details') : findTestData(
				'TestData').getValue(9, 4)]), findTestData('TestData').getValue(9, 4))
...
else if(Mobile.verifyElementExist(findTestObject('Object Repository/Transfer/TypeOfTransaction',[('type'): 'Mobile Number']),0,FailureHandling.OPTIONAL))
		{
			Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyNumberTxt', [('proxyNumber') : findTestData('TestData').getValue(
				5, 4)]), findTestData('TestData').getValue(5, 4))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountReceipientNameTxt', [('recName') : findTestData('TestData').getValue(
				2, 3)]), findTestData('TestData').getValue(2, 3))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyTypeTxt', [('proxyType') : findTestData('TestData').getValue(
				1, 4)]), findTestData('TestData').getValue(1, 4))
...
Mobile.setText(findTestObject('Banking/duitNowReferenceInputField'), findTestData('TestData').getValue(8, 5), 0)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Duit Now/duitNowReferenceContentTxt', [('reference') : findTestData('TestData').getValue(
				8, 5)]), findTestData('TestData').getValue(8, 5))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationReceipientProxyNumTxt', [('proxyNumber') : findTestData(
				'TestData').getValue(5, 4)]), findTestData('TestData').getValue(5, 4))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationPaymentDetailsInputtedTxt', [('details') : findTestData(
				'TestData').getValue(9, 5)]), findTestData('TestData').getValue(9, 5))
...
else if(Mobile.verifyElementExist(findTestObject('Object Repository/Transfer/TypeOfTransaction',[('type'): 'Business Registration Number']),0,FailureHandling.OPTIONAL))
		{
			Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyNumberTxt', [('proxyNumber') : findTestData('TestData').getValue(
				4, 5)]), findTestData('TestData').getValue(4, 5))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountReceipientNameTxt', [('recName') : findTestData('TestData').getValue(
				2, 5)]), findTestData('TestData').getValue(2, 5))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyTypeTxt', [('proxyType') : findTestData('TestData').getValue(
				1, 5)]), findTestData('TestData').getValue(1, 5))
...
Mobile.setText(findTestObject('Banking/duitNowReferenceInputField'), findTestData('TestData').getValue(8, 6), 0)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Duit Now/duitNowReferenceContentTxt', [('reference') : findTestData('TestData').getValue(
				8, 6)]), findTestData('TestData').getValue(8, 6))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationIDTypeTxt', [('proxy') : findTestData('TestData').getValue(
				1, 6)]), findTestData('TestData').getValue(1, 6))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationPaymentDetailsInputtedTxt', [('details') : findTestData(
				'TestData').getValue(9, 6)]), findTestData('TestData').getValue(9, 6))
...
else if(Mobile.verifyElementExist(findTestObject('Object Repository/Transfer/TypeOfTransaction',[('type'): 'Passport Number']),0,FailureHandling.OPTIONAL))
		{
			Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyNumberTxt', [('proxyNumber') : findTestData('TestData').getValue(
				3, 7)]), findTestData('TestData').getValue(3, 7))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountReceipientNameTxt', [('recName') : findTestData('TestData').getValue(
				2, 7)]), findTestData('TestData').getValue(2, 7))

Mobile.verifyElementText(findTestObject('Duit Now/duitNowAmountProxyTypeTxt', [('proxyType') : findTestData('TestData').getValue(
				1, 7)]), findTestData('TestData').getValue(1, 7))
...
Mobile.setText(findTestObject('Banking/duitNowReferenceInputField'), findTestData('TestData').getValue(8, 7), 0)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Duit Now/duitNowReferenceContentTxt', [('reference') : findTestData('TestData').getValue(
				8, 7)]), findTestData('TestData').getValue(8, 7))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationReceipientProxyNumTxt', [('proxyNumber') : findTestData(
				'TestData').getValue(3, 7)]), findTestData('TestData').getValue(3, 7))
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowConfirmationPaymentDetailsInputtedTxt', [('details') : findTestData(
				'TestData').getValue(9, 7)]), findTestData('TestData').getValue(9, 7))
