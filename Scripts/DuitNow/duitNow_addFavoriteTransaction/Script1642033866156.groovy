...
//}
//
//Mobile.verifyElementVisible(findTestObject('Banking/m2uAccountTypeSelection', [('text') : findTestData('TestData').getValue(5, 1)]), 10)
//
...
Mobile.scrollToText('Mobile Number', FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('Banking/duitNowSummaryAmountTxt'), 0)
...
def Trasnferstatus1 = Mobile.getText(findTestObject('Main/mainTransactionStatusMessageTxt'), 10)

println('Transaction Status' + Trasnferstatus1)
...
Mobile.takeScreenshot('/Users/a00139272/Desktop/Screenshot/duitNowAddFav.png')
