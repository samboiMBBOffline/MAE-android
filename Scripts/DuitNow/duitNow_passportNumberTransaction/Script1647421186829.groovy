...
Mobile.verifyElementExist(findTestObject('Banking/duitNowBusinessRegNoInputField', [('proxyPlaceholder') : findTestData(
                'TestData').getValue(5, 7)]), 0)

Mobile.setText(findTestObject('Banking/duitNowBusinessRegNoInputField', [('proxyPlaceholder') : findTestData('TestData').getValue(
                5, 7)]), findTestData('TestData').getValue(3, 7), 0)

Mobile.hideKeyboard()

Mobile.verifyElementExist(findTestObject('Duit Now/duitNowPassportCountryTitleTxt'), 0)

Mobile.verifyElementExist(findTestObject('Duit Now/duitNowPassportSelectCountryTitleDropdown', [('country1') : findTestData(
                'TestData').getValue(7, 7)]), 0)

Mobile.tap(findTestObject('Duit Now/duitNowPassportSelectCountryTitleDropdown', [('country1') : findTestData('TestData').getValue(
                7, 7)]), 0)

Mobile.scrollToText(findTestData('TestData').getValue(4, 7))

Mobile.tap(findTestObject('Duit Now/duitNowPassportSelectedCountryTxt', [('country') : findTestData('TestData').getValue(
                4, 7)]), 0)
...
Mobile.verifyElementText(findTestObject('Duit Now/duitNowPassportSelectCountryTitleDropdown', [('country1') : findTestData(
                'TestData').getValue(4, 7)]), findTestData('TestData').getValue(4, 7))
