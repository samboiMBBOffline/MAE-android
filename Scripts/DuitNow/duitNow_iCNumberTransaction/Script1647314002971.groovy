...
if (Mobile.verifyElementVisible(findTestObject('Tabung/tabungEnterPasswordTxt'), 0, FailureHandling.OPTIONAL)) {
    not_run: Mobile.setText(findTestObject('Tabung/tabungSignInInputPasswordField'), findTestData('TestData').getValue(2, 
            1), 0)
...
Mobile.tap(findTestObject('Banking/duitNowBusinessRegIDTypeDropdown', [('proxy') : findTestData('TestData').getValue(2, 
                2)]), 0)
