...
Mobile.waitForElementPresent(findTestObject('Festive Season/festiveSeasonDashboardQuickActionBtn'), 5)
...
Mobile.verifyElementText(findTestObject('Festive Season/sendGreetingContactSelect', [('contactName') : contactName]), contactName)
