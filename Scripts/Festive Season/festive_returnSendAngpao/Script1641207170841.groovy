...
Mobile.waitForElementPresent(findTestObject('Notification/notificationFestiveGreetingContentTxt'), 0)

Mobile.tap(findTestObject('Notification/notificationFestiveGreetingContentTxt'), 0)
...
Mobile.tap(findTestObject('Festive Season/festiveReceivedSendAngpaoBtn'), 0)
