...
WebUI.callTestCase(findTestCase('Pages/Dashboard'), [('index') : '2'], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/More'),  [('index') : '2'], FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(2)

Mobile.waitForElementPresent(findTestObject('Object Repository/More tab/Apply button/applyButton_cardsTab'), 0)

Mobile.tap(findTestObject('Object Repository/More tab/Apply button/applyButton_cardsTab'), 0)

Mobile.delay(2)

Mobile.tap(findTestObject('Object Repository/More tab/Apply button/cardsTab_CreditCardTxt'), 0)
