...
//
//Mobile.verifyElementExist(findTestObject('Object Repository/Dashboard/dashboardSSLTitleTxt'), 0)
//
...
Mobile.verifyElementText(findTestObject('Transfer/transferFavListAccNameTxt', [('accName') : payeeName]), payeeName)

Mobile.verifyElementText(findTestObject('Transfer/transferFavListAccNoTxt', [('accNo') : AccountNo]), AccountNo)

Mobile.verifyElementText(findTestObject('Transfer/transferFavListAccBankTxt', [('accBank') : payeeName]), payeeName)

Mobile.tap(findTestObject('Transfer/transferFavListAccNameTxt', [('accName') : payeeName]), 0)
...
Mobile.takeScreenshot('/Users/a00139272/Desktop/Screenshot/payBillsFav.png')
...
//
//Mobile.takeScreenshot('/Users/a00139272/git/MAEAutomation2/Performance/2G 5Bar/4.png')
//
...
//
//float newValue = Float.parseFloat(values)
//
