...
Mobile.waitForElementPresent(findTestObject('Main/mainFavBodySelect'), 0)

Mobile.tap(findTestObject('Main/mainFavBodySelect'), 0)

Mobile.delay(5)

Mobile.waitForElementPresent(findTestObject('zakat/zakatTypeDropdownSelectBox'), 0)
...
Mobile.takeScreenshot('/Users/a00139272/Desktop/Screenshot/zakatFav.png')
