...
not_run: int startX = device_Width / 3

not_run: int startY = device_Height * 0.97
...
//}
//Mobile.tap(findTestObject('Banking/m2uAccountPayBillsIconSelect'), 0)
println('JOMPAY Future Transaction')

//Mobile.tap(findTestObject('Banking/m2uAccountPayBillsIconSelect'), 0)
Mobile.tap(findTestObject('JomPay/payBillsJomPayTopMenuSelect'), 30)
...
Mobile.verifyElementText(findTestObject('JomPay/jomPaySummaryScheduledTxt'), findTestData('TestData').getValue(7, 2))

Mobile.takeScreenshot('/Users/a00139272/Desktop/Screenshot/jomPaySchedule.png')
