...
Mobile.waitForElementPresent(findTestObject('Login Onboarding/secureGetOTPTxt'), 0)

//Mobile.tap(findTestObject('Login Onboarding/secureGetOTPTxt'), 0)
...
Mobile.tap(findTestObject('Object Repository/others/MobileNo/othersOTPInputTickBtn'), 0)