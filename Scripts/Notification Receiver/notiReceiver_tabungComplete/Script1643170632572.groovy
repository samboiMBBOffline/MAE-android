...
Mobile.takeScreenshotAsCheckpoint('Tabung Complete Verification')
...
def validate = ('You\'ve completed the ' + tabungName) + ' Tabung. View Tabung to manage your contributions.'

Mobile.verifyElementText(findTestObject('Notification/notiReceiverTabungComplete_bodyTxt', [('tabungName') : tabungName]), 
    validate)
