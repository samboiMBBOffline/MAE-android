...
Mobile.takeScreenshotAsCheckpoint('Request Money Verification')
...
def data = findTestData('MAE Noti').getValue(1, 1)

println(data)

def validate = 'You’ve just received RM 0.04 from ' + mayaName + '. REF: ' + data

Mobile.verifyElementText(findTestObject('Notification/notiCreatorRequest_bodyTxt', [('mayaName') : mayaName, ('RefId') : findTestData(
                'MAE Noti').getValue(1, 1)]), validate)
