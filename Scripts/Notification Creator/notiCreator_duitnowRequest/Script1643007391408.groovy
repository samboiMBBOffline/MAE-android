...
Mobile.takeScreenshotAsCheckpoint('Duit Now Request Verification')
...
def validate = (((((('You’ve just received RM ' + value) + ' from ') + fullName) + ' for ') + refInput) + '. REF: ') + data

Mobile.verifyElementText(findTestObject('Notification/notiCreatorDuitNowRequest_bodyTxt', [('value') : value, ('fullName') : fullName
            , ('refInput') : refInput, ('RefId') : findTestData('MAE Noti').getValue(2, 1)]), validate)
