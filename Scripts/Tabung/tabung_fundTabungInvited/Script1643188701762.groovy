...
//if (Mobile.getDeviceManufacturer() == 'HUAWEI') {
...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/Festive Season/festiveReturnAngpaoTACNoTxt'), 0, FailureHandling.OPTIONAL)) {
    ...
    Mobile.tap(findTestObject('Object Repository/Festive Season/festiveSendGreetingAngpaoTACTickBtn'), 0)
} else {
