...
//def device = Mobile.getDeviceManufacturer(FailureHandling.CONTINUE_ON_FAILURE)
//println(device)
//if (device == 'HUAWEI') {
//    //Mobile.tapAtPosition(335, 2057)
//	Mobile.tapAndHoldAtPosition(335, 2057, 5)
//} else {
//    Mobile.tapAtPosition(355, 2147)
//}
//Mobile.tap(findTestObject('Main/mainMaybank2UBottomMenu'), 0)
...
//referenceID = Mobile.getText(findTestObject('SplitBill/splitBillConfirmNameTxt'), 0)
