...
Mobile.clearText(findTestObject('SplitBill/splitBillCreateContactSearchtInputField'), 0)

Mobile.delay(3)

Mobile.setText(findTestObject('SplitBill/splitBillCreateContactSearchtInputField'), findTestData('TestData').getValue(4, 97),, 0)
...
Mobile.waitForElementPresent(findTestObject('SplitBill/splitBillCameraCaptureBtn'), 30)
...
Mobile.verifyElementText(findTestObject('Main/mainTransactionStatusMessageTxt'), 'Split bill created')

Mobile.waitForElementPresent(findTestObject('Main/mainDoneBtn'), 10)

Mobile.takeScreenshot("/Users/a00139272/Desktop/Screenshot/createThreeSplitBill.png")
...
//		Mobile.callTestCase(findTestCase('Split Bill/splitBill_createSplitBillThreeFriends_Paid'), null)
//	}
//}
