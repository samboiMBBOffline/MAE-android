...
//}
//
//Mobile.verifyElementVisible(findTestObject('Dashboard/dashboardWalletTopSelect'), 0)
...
Mobile.tap(findTestObject('Transfer/instantTransferModeDuitTxt', [('mode') : initialMode]), 0)

Mobile.delay(3)

Mobile.scrollToText(selectedMode, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Transfer/instantTransferModeDropdownSelect', [('modeS') : selectedMode]), 0)
...
Mobile.verifyElementExist(findTestObject('Transfer/instantTransferModeDuitTxt', [('mode') : selectedMode]), 0)
...
Mobile.verifyElementText(findTestObject('Transfer/instantTransferConfirmationTransactionModeTxt', [('modeC') : selectedMode]), 
    selectedMode)
...
Mobile.verifyElementText(findTestObject('Transfer/transferConfirmationFromAccTypeTxt', [('accType') : accTypeFrom]), accTypeFrom)
...
if (Mobile.verifyElementVisible(findTestObject('Festive Season/seasonalGreetingAngpaoTACNoTxt'), 10, FailureHandling.OPTIONAL)) {
	...
	Mobile.tap(findTestObject('Main/mainOTPTickBtn'), 0)
} else if (Mobile.verifyElementVisible(findTestObject('Main/mainS2UApproveBtn'), 10, FailureHandling.OPTIONAL)){
	Mobile.delay(3)
...
Mobile.takeScreenshot("/Users/a00139272/Desktop/Screenshot/instantIBGFav.png")
