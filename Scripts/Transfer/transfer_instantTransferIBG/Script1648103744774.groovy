...
Mobile.tap(findTestObject('Transfer/instantTransferModeDuitTxt', [('mode') : findTestData('TestData').getValue(4, 45)]), 0)

Mobile.delay(3)

Mobile.scrollToText(findTestData('TestData').getValue(4, 46), FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Transfer/instantTransferModeDropdownSelect', [('modeS') : findTestData('TestData').getValue(4, 46)]), 0)
