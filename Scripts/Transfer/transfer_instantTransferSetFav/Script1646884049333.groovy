...
Mobile.setText(findTestObject('Banking/transferReferenceInputField'), 'AmountTransfer', 0)
...
Mobile.verifyElementVisible(findTestObject('Main/mainTransferNowBtn'), 0)
...
if (Mobile.verifyElementVisible(findTestObject('Festive Season/seasonalGreetingAngpaoTACNoTxt'), 5, FailureHandling.OPTIONAL)) {
    ...
    Mobile.verifyElementVisible(findTestObject('Main/mainS2UApproveBtn'), 3)

    Mobile.tap(findTestObject('Main/mainS2UApproveBtn'), 0)
}

println('Interbank Test Case Completed')
...
ExcelKeywords.setValueToCellByIndex(sheet1, 2, 1, referenceID)  //index row column(2,1) = (3,2)
...
Mobile.takeScreenshot("/Users/a00139272/Desktop/Screenshot/instantSetFav.png")

Mobile.verifyElementVisible(findTestObject('Main/mainDoneBtn'), 3)
