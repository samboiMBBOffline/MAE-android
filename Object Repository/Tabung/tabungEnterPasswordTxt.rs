...
<MobileElementEntity>
   ...
   <name>tabungEnterPasswordTxt</name>
   <tag></tag>
   <elementGuidId>ebf6e57d-a1e0-48ef-ad05-4e08ef3061d0</elementGuidId>
   ...
   <locator>//*[(@text = 'Forgot Password' or . = 'Forgot Password')]</locator>
