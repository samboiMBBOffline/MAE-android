...
<MobileElementEntity>
   ...
   <name>tabungThreeDtosRemoveBtn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Remove Tabung' or . = 'Remove Tabung')]</locator>
