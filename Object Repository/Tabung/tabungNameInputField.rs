...
<MobileElementEntity>
   ...
   <name>tabungNameInputField</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter Tabung name' or . = 'Enter Tabung name')]</locator>
