...
<MobileElementEntity>
   ...
   <name>tabungSelectStartDateField</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Tap to select start date' or . = 'Tap to select start date')]</locator>
