...
<MobileElementEntity>
   ...
   <name>festiveReceivedReturnGreetingBtn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Return a Greeting' or . = 'Return a Greeting')]</locator>
