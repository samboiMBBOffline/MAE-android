...
<MobileElementEntity>
   ...
   <name>seasonalSendGreetingConfirmationSendNowBtn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Send Now' or . = 'Send Now')]</locator>
