...
<MobileElementEntity>
   ...
   <name>seasonalGreetingAngpaoSummaryContactNameTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'MaeSend' or . = 'MaeSend')]</locator>
