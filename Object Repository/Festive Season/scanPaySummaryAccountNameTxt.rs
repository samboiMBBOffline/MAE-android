...
<MobileElementEntity>
   ...
   <name>scanPaySummaryAccountNameTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'JSJSJDJDJJDJDJDNDNDNDNNDJ' or . = 'JSJSJDJDJJDJDJDNDNDNDNNDJ')]</locator>
