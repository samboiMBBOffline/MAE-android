...
<MobileElementEntity>
   ...
   <name>notificationFestiveGreetingTitleTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'CNY Greeting' or . = 'CNY Greeting')]</locator>
