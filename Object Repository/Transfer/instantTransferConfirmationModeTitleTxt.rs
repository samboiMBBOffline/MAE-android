...
<MobileElementEntity>
   ...
   <name>instantTransferConfirmationModeTitleTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Transfer mode' or . = 'Transfer mode')]</locator>
