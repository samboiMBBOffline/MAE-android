...
<MobileElementEntity>
   ...
   <name>instantIBGNameInputtedNameTxt</name>
   <tag></tag>
   <elementGuidId>fbe93107-1bbb-486d-b11e-022a46ed5724</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '${accName}' or . = '${accName}')]</locator>
