...
<MobileElementEntity>
   ...
   <name>instantTransferConfirmationTypeModeAccBankTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'PUBLIC BANK' or . = 'PUBLIC BANK')]</locator>
