...
<MobileElementEntity>
   ...
   <name>transferReferenceInputFieldAfter</name>
   <tag></tag>
   <elementGuidId>8d927a64-fa94-4733-9259-7ae1251ef081</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '${reference}' or . = '${reference}')]</locator>
