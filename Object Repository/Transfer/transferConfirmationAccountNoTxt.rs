...
<MobileElementEntity>
   ...
   <name>transferConfirmationAccountNoTxt</name>
   <tag></tag>
   <elementGuidId>306afbe4-5492-4bed-94d1-9a28a8baddae</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${accNo}' or . = '${accNo}')]</locator>
