...
<MobileElementEntity>
   ...
   <name>instantTransferConfirmationTypeModeAccNameTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'RANBEER SINGH' or . = 'RANBEER SINGH')]</locator>
