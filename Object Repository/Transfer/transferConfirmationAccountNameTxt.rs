...
<MobileElementEntity>
   ...
   <name>transferConfirmationAccountNameTxt</name>
   <tag></tag>
   <elementGuidId>dbbc5569-a476-46f5-a1a7-5ad4c22413bf</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${accName}' or . = '${accName}')]</locator>
