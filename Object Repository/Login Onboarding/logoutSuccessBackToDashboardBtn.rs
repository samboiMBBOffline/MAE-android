...
<MobileElementEntity>
   ...
   <name>logoutSuccessBackToDashboardBtn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Back to Dashboard' or . = 'Back to Dashboard')]</locator>
