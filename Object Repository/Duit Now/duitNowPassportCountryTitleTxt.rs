...
<MobileElementEntity>
   ...
   <name>duitNowPassportCountryTitleTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Issuing Country' or . = 'Issuing Country')]</locator>
