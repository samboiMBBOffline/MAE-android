...
<MobileElementEntity>
   ...
   <name>duitNowPassportSelectCountryTitleDropdown</name>
   <tag></tag>
   <elementGuidId>1aecc197-b1e4-4bb1-8767-f74febe9729e</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${country1}' or . = '${country1}')]</locator>
