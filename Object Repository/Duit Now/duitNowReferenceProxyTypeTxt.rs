...
<MobileElementEntity>
   ...
   <name>duitNowReferenceProxyTypeTxt</name>
   <tag></tag>
   <elementGuidId>af92eba1-f94d-4dcb-81b0-80fba6c7c8a7</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${proxyType}' or . = '${proxyType}')]</locator>
