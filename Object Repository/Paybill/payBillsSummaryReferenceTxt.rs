...
<MobileElementEntity>
   ...
   <name>payBillsSummaryReferenceTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '181268661M' or . = '181268661M')]</locator>
