...
<MobileElementEntity>
   ...
   <name>payBillsAmountPayeeNameTxt</name>
   <tag></tag>
   <elementGuidId>95217b1b-f4e8-4a9f-b11a-1653dc8baa49</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${payee}' or . = '${payee}')]</locator>
