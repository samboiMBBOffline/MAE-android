...
<MobileElementEntity>
   ...
   <name>payBillBillerSelect</name>
   <tag></tag>
   <elementGuidId>f3e56f58-c3a1-4c31-be78-56820f9f9a90</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${payeeName}' or . = '${payeeName}') and @clickable = 'false']</locator>
