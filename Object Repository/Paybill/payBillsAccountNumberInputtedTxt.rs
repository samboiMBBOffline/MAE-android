...
<MobileElementEntity>
   ...
   <name>payBillsAccountNumberInputtedTxt</name>
   <tag></tag>
   <elementGuidId>07906b5e-8ab2-4f93-9b1c-9e07009c5540</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '${AccountNo}' or . = '${AccountNo}') and @enabled = 'true']</locator>
