...
<MobileElementEntity>
   ...
   <name>payBillsConfirmPayeeNameTxt</name>
   <tag></tag>
   <elementGuidId>e12653f9-f5c9-41da-942b-eafb3592d6fc</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${payeeName}' or . = '${payeeName}')]</locator>
