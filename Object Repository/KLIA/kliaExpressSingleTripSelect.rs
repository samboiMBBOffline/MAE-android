...
<MobileElementEntity>
   ...
   <name>kliaExpressSingleTripSelect</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Single Trip' or . = 'Single Trip')]</locator>
