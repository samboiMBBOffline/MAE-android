...
<MobileElementEntity>
   ...
   <name>kliaExpressToDropdownSelectKLSentral</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'KL Sentral' or . = 'KL Sentral')]</locator>
