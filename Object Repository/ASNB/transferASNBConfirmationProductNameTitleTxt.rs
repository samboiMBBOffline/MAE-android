...
<MobileElementEntity>
   ...
   <name>transferASNBConfirmationProductNameTitleTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Product name' or . = 'Product name')]</locator>
