...
<MobileElementEntity>
   ...
   <name>transferASNBConfirmationAccountNameTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'XXXXXXXXXX' or . = 'XXXXXXXXXX')]</locator>
