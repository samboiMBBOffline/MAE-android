...
<MobileElementEntity>
   ...
   <name>transferASNBMemberNumberTitleTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Membership number' or . = 'Membership number')]</locator>
