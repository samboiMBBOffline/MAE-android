...
<MobileElementEntity>
   ...
   <name>zakatTypeZakatEmasDropdownSelect</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Zakat Emas' or . = 'Zakat Emas')]</locator>
