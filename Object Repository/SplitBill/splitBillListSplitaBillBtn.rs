...
<MobileElementEntity>
   ...
   <name>splitBillListSplitaBillBtn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Split a Bill' or . = 'Split a Bill')]</locator>
