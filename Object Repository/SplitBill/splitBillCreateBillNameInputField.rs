...
<MobileElementEntity>
   ...
   <name>splitBillCreateBillNameInputField</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Enter bill name' or . = 'Enter bill name')]</locator>
