...
<MobileElementEntity>
   ...
   <name>splitBillDetailsBillNameTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Bill test' or . = 'Bill test')]</locator>
