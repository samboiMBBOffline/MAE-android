...
<MobileElementEntity>
   ...
   <name>splitBillDetailsThreeDotsRenameBtn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Edit Bill Name' or . = 'Edit Bill Name')]</locator>
