...
<MobileElementEntity>
   ...
   <name>splitBillSummarySplitNowBtn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Split Now' or . = 'Split Now')]</locator>
